# Slurm Modifier Unix Skill Specification

## 1. Purpose
Modify SLURM job script parameters (nodes and cores per node) and automatically convert to Linux-style line endings.
...
```
# 改为 4 节点，每节点 20 核心
slurm-modifier-unix input.slurm output.slurm --nodes 4 --cores 20

# 改为 2-10 节点范围
slurm-modifier-unix input.slurm output.slurm --nodes 2-10
```
